...
//    }
    ...
    public void the_user_selects_the_recipient_bank() {
    ...
    public void the_user_enters_the_recipient_account_number() {
...
// Step 2: Search for "Bank" in the search field in IBFT
        ...
        searchField.sendKeys("Investments");
...
//    }
    ...
    @Then("the user should see a status {string}")
    public void the_user_should_see_a_confirmation_message(String expectedMessage) {
        ...
        assert confirmationMessage.getText().equals(expectedMessage);
    }
